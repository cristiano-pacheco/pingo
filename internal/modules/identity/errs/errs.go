...
var (
	...
	ErrPasswordTooShort                = errs.New("IDENTITY_07", "Password must be at least 8 characters long", http.StatusBadRequest, nil)
	ErrPasswordNoUppercase             = errs.New("IDENTITY_08", "Password must contain at least one uppercase letter", http.StatusBadRequest, nil)
